...
function watchTask (opts){
    ...
    function rule(file){
        ...
        if ((extname === '.js' && !util.isRJS(file) && opts.js) || (util.isRJS(file) && opts.rjs) || extname === '' || (extname === '.css' && opts.css) || (extname === '.scss' && opts.sass) || (opts.image && opts.image.patterns.indexOf(extname) !== -1)) {
            return true;
        }
